...
- Treat your lab mates with due respect. Racial or sexist comments will not be tolerated under any circumstance. The lab should be a place where everybody feels welcome and appreciated.
- At any given time your lab mates will be doing different activities that require different levels of concentration. Respect this. 

### **Expectations**  

#### - Work hours.  
We are lucky enough to work in an area where flexible working hours are the norm. There will be times when your project requires to work in the weekends or late. Is OK then to take some time off. However, in order to be able to interact with the rest of the persons in the labs **we expect everyone to be in the lab between 9:00 to 14:00** since this is when most of the academic activities will happen. If you take holidays, let us know in advance and fill out the corresponding *comisión*. Same applies if you go to do field work. If you don´t do it becomes complicated to plan activities.   

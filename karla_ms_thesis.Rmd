...
[Table S1. Information of the Diversity Panel landraces](https://github.com/rr-lab/rr-lab.github.io/blob/master/data/karla_thesis/sup_table_1.csv)

[Table S2. Developmental stage at which each plant of the RIL population was sampled](https://github.com/rr-lab/rr-lab.github.io/blob/master/data/karla_thesis/sup_table_2.csv)

[Table S3. Developmental stage at which each plant of DP population was sampled](https://github.com/rr-lab/rr-lab.github.io/blob/master/data/karla_thesis/sup_table_3.csv)

[Table S4. Variable contribution to PC1 and PC2 of Figures 9 and 10](https://github.com/rr-lab/rr-lab.github.io/blob/master/data/karla_thesis/sup_table_4.csv)

[Table S7. Fold changes and p values of significantly different lipids between B73 and PT in Figure 14](https://github.com/rr-lab/rr-lab.github.io/blob/master/data/karla_thesis/sup_table_7.csv)

[Table S8. Ratios of RILS with extreme PC/LPC ratios](https://github.com/rr-lab/rr-lab.github.io/blob/master/data/karla_thesis/sup_table_8.csv)
